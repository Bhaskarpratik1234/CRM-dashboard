                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content justify-content-center">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                            <h5 class="modal-title text-center text-capitalize fs-24 fw-medium mb-4" id="zoomInModalLabel" style=" justify-content:center;">SEO METRICS FILTER</h5>
                                                                <div class="col-xl-8 mb-3">
                                                                    <div class="input-group">
                                                                        <input type="text" class="form-control" placeholder="Enter filter name" aria-label="Enter filter name" aria-describedby="basic-addon2">
                                                                        <button class="input-group-text  btn btn-secondary" id="basic-addon2">Save Filters</button>
                                                                    </div>
                                                                </div>
                                                                <div class="col-xl-4 mb-3">
                                                                    <div class="btn-group">
                                                                        <button class="btn btn-outline-success waves-effect waves-light dropdown-toggle" type="button" id="dropdownMenuClickableInside" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                                                        ...
                                                        <div class="modal-footer justify-content-center">
                                                            ...
                                                            <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#flipModal">Apply Filters</button>
                                                        </div>
                                          ...
                                          <div id="flipModal" class="modal fade flip" tabindex="-1" aria-labelledby="flipModalLabel" aria-hidden="true" style="display: none;">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <h5 class="modal-title text-center mb-5" id="flipModalLabel">SEO METRICS</h5>
                                                            <h5 class="fs-18 fw-normal"> Fetching Metrics </h5>
                                                            <div class="card" style="border: 1px dashed var(--Neutrals-4, #E4E4E7); background: rgba(69, 28, 192, 0.01); width: 456px; height: 180px; flex-shrink: 0;">
                                                                    <img src="./assets/images/products-progress.png" width="68" height="68" alt="" srcset="">
                                                            <!-- <svg xmlns="http://www.w3.org/2000/svg" width="68" height="68" viewBox="0 0 68 68" fill="none">
                                                                    <circle cx="34" cy="34" r="32" stroke="#E4E4E7" stroke-width="4"/>
                                                                    </svg> -->
                                                                <h5 class="fs-18 fw-normal text-center mt-5 mb-3"> Fetching site metrics... </h5>
                                                                <div class="modal-footer justify-content-center">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12 mb-3">
                                                                    <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                                                                        <div class="flex-grow-1">
                                                                            <h5 class="fs-14 mb-1 fw-normal fst-italic ">Estimated remaining time : 20 mins </h5>
                                                                            
                                                                        </div>
                                                                        <div class="flex-shrink-0">
                                                                            <a href="http://" class="fs-14 mb-1 fw-normal"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                                                                <g clip-path="url(#clip0_5385_10206)">
                                                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M15.1673 6.66927C15.1673 5.6566 14.3467 4.83594 13.334 4.83594H6.66732C5.65465 4.83594 4.83398 5.6566 4.83398 6.66927V13.3359C4.83398 14.3486 5.65465 15.1693 6.66732 15.1693H13.334C14.3467 15.1693 15.1673 14.3486 15.1673 13.3359V6.66927ZM14.1673 6.66927V13.3359C14.1673 13.7959 13.794 14.1693 13.334 14.1693H6.66732C6.20732 14.1693 5.83398 13.7959 5.83398 13.3359V6.66927C5.83398 6.20927 6.20732 5.83594 6.66732 5.83594H13.334C13.794 5.83594 14.1673 6.20927 14.1673 6.66927Z" fill="#121212"/>
                                                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M11.1673 5.33594V2.66927C11.1673 1.6566 10.3467 0.835938 9.33398 0.835938H2.66732C1.65465 0.835938 0.833984 1.6566 0.833984 2.66927V9.33594C0.833984 10.3486 1.65465 11.1693 2.66732 11.1693H5.33398C5.60998 11.1693 5.83398 10.9453 5.83398 10.6693C5.83398 10.3933 5.60998 10.1693 5.33398 10.1693H2.66732C2.20732 10.1693 1.83398 9.79594 1.83398 9.33594V2.66927C1.83398 2.20927 2.20732 1.83594 2.66732 1.83594H9.33398C9.79398 1.83594 10.1673 2.20927 10.1673 2.66927V5.33594C10.1673 5.61194 10.3913 5.83594 10.6673 5.83594C10.9433 5.83594 11.1673 5.61194 11.1673 5.33594Z" fill="#121212"/>
                                                                                </g>
                                                                                <defs>
                                                                                    <clipPath id="clip0_5385_10206">
                                                                                    <rect width="16" height="16" fill="white"/>
                                                                                    </clipPath>
                                                                                </defs>
                                                                                </svg> Run in background</a>
                                                                            <!-- <button type="button" class="btn btn-outline-success waves-effect waves-light fs-16 fw-normal" data-bs-toggle="modal" data-bs-target="#exampleModalPopovers"><i class="ri-upload-cloud-2-fill"></i> Import</button> -->
